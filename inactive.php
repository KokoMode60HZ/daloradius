...
<!-- Sidebar Navigation and Topbar (full content from ppp.php/index.php) -->
    ...
    <div style="background:#fff;border-radius:10px;padding:24px;box-shadow:0 2px 8px rgba(0,0,0,0.07);">
        <div style="font-size:1.3em;font-weight:bold;margin-bottom:16px;display:flex;align-items:center;gap:18px;">
            <a href="ppp.php" style="color:#009688;font-weight:bold;font-size:1.1em;text-decoration:none;display:flex;align-items:center;">
                <span style="display:inline-block;">Session Aktif</span>
            </a>
            <span style="font-size:1.2em;color:#009688;">
                <i class="fas fa-arrow-right"></i>
            </span>
            <span style="color:#111;font-weight:bold;">Pelanggan Offline</span>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    function setupToggle(toggleId, submenuId, arrowId) {
        ...
        if (toggle && submenu && arrow) {
            toggle.addEventListener('click', function() {
                ...
                arrow.querySelector('img').style.transform = isOpen ? '' : 'rotate(-90deg)';
            });
        }
    }
    setupToggle('sessionuser-toggle', 'sessionuser-submenu', 'sessionuser-arrow');
    setupToggle('pengaturan-toggle', 'pengaturan-submenu', 'pengaturan-arrow');
    setupToggle('odp-toggle', 'odp-submenu', 'odp-arrow');
    setupToggle('profil-toggle', 'profil-submenu', 'profil-arrow');
    setupToggle('pelanggan-toggle', 'pelanggan-submenu', 'pelanggan-arrow');
    setupToggle('voucher-toggle', 'voucher-submenu', 'voucher-arrow');
    setupToggle('tagihan-toggle', 'tagihan-submenu', 'tagihan-arrow');
    setupToggle('keuangan-toggle', 'keuangan-submenu', 'keuangan-arrow');
    setupToggle('payment-toggle', 'payment-submenu', 'payment-arrow');
    setupToggle('tiket-toggle', 'tiket-submenu', 'tiket-arrow');
    setupToggle('tools-toggle', 'tools-submenu', 'tools-arrow');
    setupToggle('log-toggle', 'log-submenu', 'log-arrow');
});
</script>